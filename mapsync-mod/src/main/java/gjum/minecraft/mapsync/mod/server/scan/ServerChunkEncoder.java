package gjum.minecraft.mapsync.mod.server.scan;
...
/// Server-side equivalent of [gjum.minecraft.mapsync.mod.sync.Cartography]'s
/// `chunkTileFromLevel` + [gjum.minecraft.mapsync.mod.data.ChunkTile]'s
